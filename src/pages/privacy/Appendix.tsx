    ...
    <>
      <section className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal space-y-2 pl-5 text-foreground/80">
            ...
            <li>
              ...
              expected for a non-commercial association. No action needed unless VAT registration is
              planned.
            </li>
          </ol>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal space-y-2 pl-5 text-foreground/80">
            ...
            <li>
              ...
              of the Lovable deployment or be fully retired. If retained, list which services remain
              and their data processing locations.
            </li>
            <li>
            ...
            <li>
              ...
              media embeds, maps, video embeds, or CAPTCHA services were detected on the demo. Fonts
              are self-hosted (Quicksand + Plus Jakarta Sans). Verify whether any additional
              third-party services are added before launch (maps, videos, social plugins, CAPTCHA,
              Unsplash API, newsletter tracking pixels).
            </li>
            <li>
              ...
              &quot;built but gated off&quot;). Remove or adjust privacy policy sections for
            ...
            <li>
              ...
              &quot;Privacy&quot;, &quot;Imprint&quot;, and &quot;Code of Ethics&quot; links in the
              footer (marked &quot;Coming soon&quot;). Ensure these link to the published pages once
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal space-y-2 pl-5 text-foreground/80">
            <li>
              <strong>Newsletter signup fields</strong> — The demo site has a newsletter signup with
              an email input field in the footer. Confirm whether additional fields are collected
              beyond email.
            </li>
            <li>
              <strong>Event registration fields</strong> — The demo shows events with date,
              location, language, and topic. Confirm all fields collected during event registration
              (name, email, organisation, dietary requirements, accessibility, etc.).
            </li>
            <li>
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal space-y-2 pl-5 text-foreground/80">
            ...
            <li>
              <strong>Local storage / similar technologies</strong> — Check for use of localStorage,
              sessionStorage, IndexedDB, fingerprinting, or other tracking technologies on the live
              site.
            </li>
          </ol>
        </div>
