    ...
    <>
      <section className="space-y-6">
        ...
        <InfoCallout>
          ...
          <p className="mt-2">
            <strong>Master language:</strong> English. DE / FR / IT translations to be produced from
            the approved English master.
          </p>
          <p className="mt-1">
          ...
          <p className="mt-1">
            ...
            revised version in force since 1 September 2023); Federal Act against Unfair Competition
            (UWG, SR 241), Art. 3 para. 1 let. s.
          </p>
          <p className="mt-1">
