      ...
      <section className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-foreground/80">
            ...
            Switzerland has no influence. The Switzerland Chapter of ICF therefore accepts no
            liability for the content of external sites. The respective provider or operator of the
            linked sites is always responsible for their content.
          </p>
        </div>
