    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-5 right-5 z-50 inline-flex min-h-11 items-center gap-2 rounded-full bg-hero px-5 py-3 text-sm font-semibold text-hero-foreground shadow-lg transition-colors hover:bg-hero/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        >
