...
export function SiteHeaderBar({ compact = false }: { compact?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <a
        href="#main"
        className="sr-only left-0 top-0 z-50 rounded-full bg-white text-sm font-semibold text-primary focus:not-sr-only focus:absolute focus:!px-4 focus:!py-2.5 focus-visible:!outline-primary"
      >
